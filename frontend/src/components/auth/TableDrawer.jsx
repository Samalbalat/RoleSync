	...
	return (
		<>
			...
			<div
				...
				className='group relative w-20 hover:w-24 h-screen bg-gray-900/85 backdrop-blur-md border-l border-white/10 text-white flex flex-col items-center justify-center shrink-0 sticky top-0 z-20 cursor-pointer shadow-2xl transition-all duration-300 ease-out'
			>
