		...
		<div className='min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100'>
			...
			<main className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12'>
				<div className='bg-white rounded-lg shadow-lg p-8 mb-12'>
					...
					<p className='text-gray-700 text-lg mb-6'>Administra y sincroniza los roles de tu aplicación de forma eficiente y segura.</p>
					<button className='bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2 px-6 rounded-lg transition duration-200'>Comenzar</button>
				</div>
