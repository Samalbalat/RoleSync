...
Pretendemos crear una aplicación que facilite la coordinación para los juegos de rol de mesa y la comunicación para el rol realizado en escrito, acompañando todo esto con exhaustivo sistema de reseñas y métricas que acompañen la experiencia para incitar la mejoría y bienestar de la comunidad
...
- Extensiones como SpringBoot Tools, SQL Tools, ThunderClient, Maven y el paquete Java son altamente recomendadas
